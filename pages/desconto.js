    ...
    return (
        ...
        <section className="section has-text-centered has-background-roxo-claro">
          <div className="container">
            ...
            <br/>
            <br/>
            <a href="https://api.whatsapp.com/send?phone=554391914561&text=Oiie,%20quero%20de%20mais%20informa%C3%A7%C3%B5es%20sobre%20o%20cuso"><i className="fab fa-whatsapp fa-6x"></i></a>
          </div>
        </section>
