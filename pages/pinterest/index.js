...
<section className="section separador3 has-text-centered">
          <div className="container">
            ...
            <div className="columns">
              ...
              <div className="column has-text-centered is-2 has-background-roxo redondo2 esquerda2"><br/><br/><p className="is-size-10 has-text-white destaque">8,12</p><p className="has-text-white">no cartão ou R$34,97 a vista.</p></div>
