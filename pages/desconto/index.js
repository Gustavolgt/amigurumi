...
const Home = () => {
    ...
    var toasts = [
        new Toast('success', 'Teresa Dias', 'cartão de crédito.', '51'),
        new Toast('info', 'Fernanda S.', 'boleto.', '45'),
        new Toast('success', 'Cris Lima Silva', 'cartão de crédito.', '42'),
    ...
    return (
        <>
            <Head>
                ...
                <meta name="facebook-domain-verification" content="8e3ic63yxeolsb2g2m7eh5rnxac5a2" />
                <link
                    rel="stylesheet"
            ...
            {openModal?(<div className="col-10 offset-1 border rounded border-2 shadow my-2"  >
              ...
              Inscrever-me Agora
                ...
                <div className="my-2 mb-6 has-text-centered">
                    <a onClick={()=>handleModal()}><button className="botao2-mobile animate__animated animate__pulse animate__infinite is-hidden-desktop is-hidden-tablet">Inscrever-me Agora</button></a>
                </div>
                ...
                <section className="section has-text-centered bg-circle">
                    <div className="container">
                        ...
                        <div className="columns">
                            ...
                            <div className="column is-hidden-mobile"><img src="img/input.png" alt=""/> </div>
                        </div>
                    </div>
                </section>
          ...
          <div className="container">
            ...
            <div className="columns is-mobile">
              ...
              <div className="column has-text-centered is-8 has-background-roxo redondo2 "><br/><p className="is-size-10 has-text-white destaque">9,41</p><p className="has-text-white">no cartão ou R$34,97 a vista.</p></div>
            </div>
            <div className="columns is-mobile">
        ...
        <section className="p-4 has-background-black has-text-centered has-text-white">
          ...
          <img href="https://app.monetizze.com.br/r/ARC15357455/?u=DU58594" width="1" height="1"/>
        </section>
            </>)}
            </main>
        </>
